...
**PracticaCSSFinal** es un sitio web multipage desarrollado con HTML5 y CSS3 como práctica final de la Unidad 2. El proyecto aplica principios de diseño responsivo, semántica HTML, el modelo de caja CSS, Flexbox y media queries para adaptar el sitio a diferentes dispositivos.
...
| CSS3 | Estilos, layouts y diseño responsivo |
| Flexbox | Disposición flexible de elementos |
| CSS Grid | Layout de tarjetas y secciones |
| Media Queries | Adaptación a pantallas ≤700px |
...
- Sección introductoria con foto de perfil
- 4 artículos/cards sobre proyectos desarrollados
